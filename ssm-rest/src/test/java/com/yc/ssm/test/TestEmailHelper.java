...
public class TestEmailHelper {
	...
	public static String myEmailAccount = "yaochaoqc@yeah.net";
	public static String myEmailPassword = "8051991101Yc";
	...
	// 收件人邮箱（替换为自己知道的有效邮箱）
	public static String receiveMailAccount = "718090217@qq.com";
